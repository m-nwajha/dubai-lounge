...
const FEATURES = [
  {
    ...
    icon: (
      <path
        d="M4 8l3 2 5-6 5 6 3-2-2 10H6L4 8z"
  ...
  },
  {
    ...
    icon: (
      <>
        <path
          d="M4 18v-4a2 2 0 0 1 2-2h12a2 2 0 0 1 2 2v4"
          strokeLinecap="round"
          strokeLinejoin="round"
        />
        <path
          d="M3 18h18M5 12V9a2 2 0 0 1 2-2h10a2 2 0 0 1 2 2v3"
          strokeLinecap="round"
        />
      </>
    ),
    ...
    <section className="relative flex min-h-[100svh] w-full flex-col justify-center overflow-hidden bg-black pt-24 pb-14 sm:pt-28">
      ...
      <Container variant="xl" className="relative z-10">
        <div className="max-w-xl">
          <p className="font-script text-2xl text-[#fbce6b] sm:text-3xl">
          ...
          <p className="mt-5 max-w-md text-sm leading-relaxed text-white/70 sm:text-base">
            Erlebe entspannte Abende mit Premium-Shisha, erfrischenden Drinks
            und leckeren Speisen in stilvoller Atmosphäre.
          </p>
